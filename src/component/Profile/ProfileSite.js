...
export default function ProfileSite() {
  ...
  const [userShowLogo, setUserShowLogo] = React.useState(name);
  const [state, setState] = useState(userloginname);
  console.log(state);
  return (
        ...
        <div className="content">
          <section className="info-boxes">
            ...
            <div className="info-box">
              ...
              <div className="box-content">
                <span className="big"> Food Plan</span>
                ...comming soon
              </div>
            </div>
            <div className="info-box active">
              ...
              <div className="box-content">
                <span className="big">Gender</span>
                {state?.gender}
              </div>
            </div>
            <div className="info-box">
              ...
              <div className="box-content">
                <span className="big">reviews</span>
                {state?.reviews}
                null
              </div>
            </div>
